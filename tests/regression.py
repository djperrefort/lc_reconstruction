...
"""Tests for the regression functionality."""
...
class Regression(TestCase):
    ...
    def test_band_prediction(self):
        ...
        gp = lc_regression.fit_gaussian_process(self.data)
        gp_flux, gp_err = lc_regression.predict_band_flux(
    ...
    def test_light_curve_prediction(self):
        ...
        gp = lc_regression.fit_gaussian_process(self.data)
        gp_flux, gp_err = lc_regression.predict_light_curve(gp, bands, times)
